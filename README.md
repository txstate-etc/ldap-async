...
const persons = await ldap.search('ou=people,dc=yourdomain,dc=com', { scope: 'sub', filter: 'objectclass=person' })
for (person of persons) {
  console.log(person.toJSON()) // [{ givenName: 'John', ... }, { givenName: 'Mary', ... }]
}
```
## Return object
